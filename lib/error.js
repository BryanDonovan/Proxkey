var Errors = {
    ...
    "RouteMustHaveResponseData": "Routes must have a defualt response object which contains data to return (check the `success` args",
    ...
    "CheckResponseData": "Check response data, key might not match the params key"
};
